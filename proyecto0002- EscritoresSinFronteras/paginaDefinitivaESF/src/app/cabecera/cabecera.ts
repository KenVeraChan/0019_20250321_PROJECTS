...
export class Cabecera implements OnInit {
    ...
    public mostrarHamburguesa: boolean = false; // Menú hamburguesa si ancho < 900px
    ...
    private actualizarModoMenu(): void {
      this.tamanioPantalla = window.innerWidth;
      this.mostrarHamburguesa = this.tamanioPantalla < 900;
    }
